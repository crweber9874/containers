...
# setwd("/home/kreuning/UDS_CV") # SETWD TO MAIN FOLDER NOT SUBFOLDER
...
ii <- ii.pass 
  ...
  mod.rob <- stan(file="AP_K_Fold/UDS_K_Fold/UDS_Rob_CV.stan",
                  data=stan.data,
  ...
  save(ll, file=paste("AP_K_Fold/UDS_K_Fold/UDS_Rob_CV_", ii, ".RData", sep=""))
  q()
