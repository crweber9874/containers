...
# for(ii in 1:part.n){
  ...
  mod.dyn <- stan(file = "AP_K_Fold/MQ_K_Fold/MQ_Dynamic_CV.stan",cores=6, chains=6, iter=8000, thin=10,
  ...
  save(ll, file=paste("AP_K_Fold/MQ_K_Fold/MQ_Dyn_CV_", ii, ".RData", sep=""))
