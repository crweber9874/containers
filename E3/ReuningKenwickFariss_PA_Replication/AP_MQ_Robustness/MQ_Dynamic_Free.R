...
mod.dyn <- stan(file = "AP_MQ_Robustness/MQ_Dynamic_Free.stan",cores=4, chains=4, iter=2000, thin=2, seed=270512706,
...
save(theta.dyn, up.dyn, lo.dyn, file="AP_MQ_Robustness/dyn_theta_Free.RData")

###### Comment out below to not save a ~5 gig file ####
save.image("AP_MQ_Robustness/dynamic_all_Free.RData")
...
save(waic.dyn, file = "AP_MQ_Robustness/dyn_waic_Free.RData")
save(dyn.pred, file = "AP_MQ_Robustness/dyn_pred_Free.RData")
...
####### Figure 23 ########
pdf("plots/Figure_23E.pdf", height=6, width=6)
