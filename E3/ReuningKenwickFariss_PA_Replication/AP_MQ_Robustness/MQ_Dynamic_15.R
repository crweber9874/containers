...
mod.dyn <- stan(file = "MAIN_MQ_Replication/MQ_Dynamic.stan",cores=4, chains=4, iter=2000, thin=2, seed=955982299,
...
save(theta.dyn, up.dyn, lo.dyn, file="AP_MQ_Robustness/dyn_theta_15.RData")

###### Comment out below to not save a ~5 gig file ####
save.image("AP_MQ_Robustness/dynamic_all_15.RData")
...
save(waic.dyn, file = "AP_MQ_Robustness/dyn_waic_15.RData")
save(dyn.pred, file = "AP_MQ_Robustness/dyn_pred_15.RData")
...
####### Figure 23 ########
pdf("plots/Figure_23C.pdf", height=6, width=6)
